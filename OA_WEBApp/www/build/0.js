...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(1);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(30);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__backlog__ = __webpack_require__(792);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__backlogService__ = __webpack_require__(779);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(1);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(30);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__contacts_detail__ = __webpack_require__(793);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__backlog_backlog_module__ = __webpack_require__(704);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__backlog_backlog_detail_backlog_detail_module__ = __webpack_require__(703);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__contacts_contacts_module__ = __webpack_require__(706);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__contacts_contacts_detail_contacts_detail_module__ = __webpack_require__(705);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
    ...
    HomeModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["I" /* NgModule */])({
            ...
            imports: [
                ...
                __WEBPACK_IMPORTED_MODULE_3__backlog_backlog_module__["BacklogModule"],
                __WEBPACK_IMPORTED_MODULE_4__backlog_backlog_detail_backlog_detail_module__["BacklogDetailModule"],
                __WEBPACK_IMPORTED_MODULE_5__contacts_contacts_module__["ContactsModule"],
                __WEBPACK_IMPORTED_MODULE_6__contacts_contacts_detail_contacts_detail_module__["ContactsDetailModule"],
            ],
            exports: [
                __WEBPACK_IMPORTED_MODULE_2__home__["a" /* Home */]
            ]
 ...
 */
var BacklogDetail = /** @class */ (function () {
 ...
 * on Ionic pages and navigation.
 */
var ContactsDetail = /** @class */ (function () {
...
var Home = /** @class */ (function () {
    ...
    Home = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["m" /* Component */])({
            selector: 'page-home',template:/*ion-inline-start:"/Users/lieon/Desktop/OA_WEBApp/OA_WEBApp/src/pages/home/home.html"*/'<ion-header>\n\n    <ion-navbar>\n        <button ion-button icon-only menuToggle>\n            <ion-icon name="menu"></ion-icon>\n        </button>\n        <ion-title>首页</ion-title>\n    </ion-navbar>\n\n</ion-header>\n\n\n<ion-content>\n    <ion-grid>\n        <ion-row class="index-row">\n            <ion-col col-4 *ngFor="let p of appPages" (click)="openPage(p)">\n                <div [class]="p.color">\n                    <ion-icon [name]="p.icon"></ion-icon>{{p.title}}\n                </div>\n            </ion-col>\n        </ion-row>\n    </ion-grid>\n    <ion-list>\n        <ion-list-header><ion-icon name="ios-car" color="primary">会议管理</ion-icon></ion-list-header>\n        <ion-grid>\n            <ion-row>\n                <ion-col col-3 col-xl-2 (click)="open(\'MeetingPage\')">我的会议</ion-col>\n                <ion-col col-3 col-xl-2 (click)="open(\'MeetingMinutesPage\')">会议记录</ion-col>\n                <ion-col col-3 col-xl-2 (click)="open(\'MeetingSearchPage\')">会议查询</ion-col>\n                <ion-col col-3 col-xl-2 (click)="open(\'MeetingRoomPage\')">会议室管理</ion-col>\n            </ion-row>\n        </ion-grid>\n\n        <ion-list-header><ion-icon name="ios-car" color="primary">车辆管理</ion-icon></ion-list-header>\n        <ion-grid>\n            <ion-row>\n                <ion-col col-3 col-xl-2 (click)="open(\'CarPage\')">车辆档案</ion-col>\n                <ion-col col-3 col-xl-2 (click)="open(\'DriverPage\')">司机档案</ion-col>\n            </ion-row>\n        </ion-grid>\n\n        <ion-list-header><ion-icon name="ios-car" color="primary">人事管理</ion-icon></ion-list-header>\n        <ion-grid>\n            <ion-row>\n                <ion-col  col-3 col-xl-2   (click)="open(\'TrainingMaintenancePage\')">培训维护</ion-col>\n                <ion-col  (click)="open(\'StaffFileMaintenance\')">员工档案维护</ion-col>\n                <ion-col  (click)="open(\'StaffFileMaintenanceSet\')">员工档案维护添加</ion-col>\n                <ion-col  col-3 col-xl-2  (click)="open(\'JobTypesSetPage\')">工种设置</ion-col>\n                <ion-col  col-3 col-xl-2  (click)="open(\'ContractListPage\')">合同查询</ion-col>\n                <ion-col  col-3 col-xl-2  (click)="open(\'ContractMaintenancePage\')">合同维护</ion-col>\n                <ion-col  col-3 col-xl-2  (click)="open(\'ContractRenewPage\')">合同续签</ion-col>\n                <ion-col  col-3 col-xl-2  (click)="open(\'ContractSettingPage\')">合同详情</ion-col>\n                <ion-col  (click)="open(\'FileApplicationListPage\')">申请档案查看</ion-col>\n                <ion-col  (click)="open(\'FileApplicationReviewPage\')">申请档案审批</ion-col>\n            </ion-row>\n        </ion-grid>\n\n        <ion-list-header><ion-icon name="ios-car" color="primary">考勤管理</ion-icon></ion-list-header>\n        <ion-grid>\n            <ion-row>\n                <ion-col  col-3 col-xl-2   (click)="open(\'HolidayGroupSettingsPage\')">假期分组设定</ion-col>\n                <ion-col  (click)="open(\'StaffAttendanceSettingsPage\')">员工考勤设定</ion-col>\n            </ion-row>\n        </ion-grid>\n\n    </ion-list>\n\n\n</ion-content>\n'/*ion-inline-end:"/Users/lieon/Desktop/OA_WEBApp/OA_WEBApp/src/pages/home/home.html"*/,
        }),
