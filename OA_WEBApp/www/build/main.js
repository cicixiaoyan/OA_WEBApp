...
var BacklogService = (function () {
    ...
    BacklogService.prototype.getDone = function (id) {
        return this.httpService.postFormData('/ashx/TodoLs.ashx', { Id: id }).map(function (res) { return res.json(); });
    };
    BacklogService.prototype.getNotDone = function (id) {
        return this.httpService.postFormData('/ashx/TodoLs.ashx', { Id: id }).map(function (res) { return res.json(); });
    };
...
var BacklogDetail = (function () {
    ...
    BacklogDetail.prototype.initializeItems = function () {
        var _this = this;
        this.backlogService.getDone(this.navParams.get("id")).subscribe(function (resJson) {
            if (resJson.Result) {
                ...
                if (result) {
                    ...
                    _this.storage.get('UserInfo').then(function (userInfo) {
                        if (userInfo) {
                            ...
                            _this.globalData.Uid = userInfo.Uid;
                            _this.globalData.Name = userInfo.Name;
                            _this.globalData.token = userInfo.Token;
                        }
                        else {
